...
memset_float64:
	  ...
	  for_16:
		...
		vmovaps [rax], ymm0    ; copio nei primi 8 valori dell'array il valore val
		vmovaps [rax+32], ymm0    ; copio nei primi 8 valori dell'array il valore val

		sub rdx, 16             ;sottraggo gli 8 elementi già presi
    		add rax, 64            ;mi sposto di 8 elementi (32 posizioni)
