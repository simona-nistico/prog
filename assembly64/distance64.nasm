...
distance64:
	   ...
	   for_64:
  		  ...
  		  cmp rdx, 64	    ; Confronto edx >= 32 ? repeat
		  jge for_64   ; Se edx è più grande o uguale a 32, salto al for

	   for_32:

		  cmp rdx, 32	    ; Confronto edx < 8 ? salta al for4
		  jl for_16   ; Se mancano meno di 8 elementi vai alla gestione residuo
	   ...
	   for_16:
		  ...
		  cmp rdx, 16	    ; Confronto edx < 8 ? salta al for4
		  jl for_8   ; Se mancano meno di 8 elementi vai alla gestione residuo
  		  ...
  		  vmovaps ymm0, [rax+32]    ; in ymm0 metto i secondi 8 valori di x1
   		  vmovaps ymm1, [rcx+32]    ; in ymm1 metto i secondi 8 valori di x2
    		  ...
    		  vsubps ymm0, ymm1      ; ymm0 = ymm0-ymm1  (x1-x2)  diff = x1[i]-x2[i];
   		  vmulps ymm0, ymm0      ; ymm0 = ymm0*ymm0           diff*diff;
   		  vaddps ymm2, ymm0      ; ymm2 = ymm2+ymm0           sum += diff*dif
