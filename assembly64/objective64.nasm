...
objective64:
	  ...
	  for_64:
		...
		vaddps ymm0,[rdx+224]
  	        ...
  	        sub rbx, 64            ;sottraggo i 32 elementi già presi
    		add rdx, 256           ;mi sposto di 32 elementi (128 posizioni)

    		cmp rbx, 64	       ; Confronto n*m >= 32 ? repeat32
	  ...
	  for_32:
		...
		sub rbx, 16             ;sottraggo gli 8 elementi già presi
    		add rdx, 64            ;mi sposto di 8 elementi (32 posizioni)
