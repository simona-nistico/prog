...
den    equ   12    ; int divisore, unico per tutta l'operazione occupa 32 bit (4 bytes)
d      equ   16    ; intero a 32 bit rappresenta la dimensione da dividere
...
for_64:
    ...
    movaps xmm0, [eax]    ; xmm0 = tmp[i*d_star]
...
for_remain:
    ...
    movss xmm0, [eax]    ; xmm0 = tmp[i*d_star]
