...
for_128:
    ...
    movaps xmm0, [eax+256]    ; in xmm0 metto i primi 4 valori di x1
    movaps xmm1, [ecx+256]    ; in xmm1 metto i primi 4 valori di x2
    ...
    movaps xmm0, [eax+272]    ; in xmm0 metto i secondi 4 valori di x1
    movaps xmm1, [ecx+272]    ; in xmm1 metto i secondi 4 valori di x2
    ...
    movaps xmm0, [eax+288]    ; in xmm0 metto i primi 4 valori di x1
    movaps xmm1, [ecx+288]    ; in xmm1 metto i primi 4 valori di x2
    ...
    movaps xmm0, [eax+304]    ; in xmm0 metto i secondi 4 valori di x1
    movaps xmm1, [ecx+304]    ; in xmm1 metto i secondi 4 valori di x2
    ...
    movaps xmm0, [eax+320]    ; in xmm0 metto i primi 4 valori di x1
    movaps xmm1, [ecx+320]    ; in xmm1 metto i primi 4 valori di x2
    ...
    movaps xmm0, [eax+336]    ; in xmm0 metto i secondi 4 valori di x1
    movaps xmm1, [ecx+336]    ; in xmm1 metto i secondi 4 valori di x2
    ...
    movaps xmm0, [eax+352]    ; in xmm0 metto i primi 4 valori di x1
    movaps xmm1, [ecx+352]    ; in xmm1 metto i primi 4 valori di x2
    ...
    movaps xmm0, [eax+368]    ; in xmm0 metto i secondi 4 valori di x1
    movaps xmm1, [ecx+368]    ; in xmm1 metto i secondi 4 valori di x2
    ...
    movaps xmm0, [eax+384]    ; in xmm0 metto i primi 4 valori di x1
    movaps xmm1, [ecx+384]    ; in xmm1 metto i primi 4 valori di x2
    ...
    movaps xmm0, [eax+400]    ; in xmm0 metto i secondi 4 valori di x1
    movaps xmm1, [ecx+400]    ; in xmm1 metto i secondi 4 valori di x2
    ...
    movaps xmm0, [eax+416]    ; in xmm0 metto i primi 4 valori di x1
    movaps xmm1, [ecx+416]    ; in xmm1 metto i primi 4 valori di x2
    ...
    movaps xmm0, [eax+432]    ; in xmm0 metto i secondi 4 valori di x1
    movaps xmm1, [ecx+432]    ; in xmm1 metto i secondi 4 valori di x2
    ...
    movaps xmm0, [eax+448]    ; in xmm0 metto i primi 4 valori di x1
    movaps xmm1, [ecx+448]    ; in xmm1 metto i primi 4 valori di x2
    ...
    movaps xmm0, [eax+464]    ; in xmm0 metto i secondi 4 valori di x1
    movaps xmm1, [ecx+464]    ; in xmm1 metto i secondi 4 valori di x2
    ...
    movaps xmm0, [eax+480]    ; in xmm0 metto i primi 4 valori di x1
    movaps xmm1, [ecx+480]    ; in xmm1 metto i primi 4 valori di x2
    ...
    ;Loop Unrolling 31: 4 valori
    movaps xmm0, [eax+496]    ; in xmm0 metto i secondi 4 valori di x1
    movaps xmm1, [ecx+496]    ; in xmm1 metto i secondi 4 valori di x2
